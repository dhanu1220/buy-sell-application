...
def create_checkout_session(request, id):
    ...
    try:
        ...
        order.stripe_payment_intent = checkout_session.get('id')  # Use 'id' instead of 'payment_intent'
...
class PaymentSuccessView(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        order = get_object_or_404(OrderDetail, stripe_payment_intent=session.id)  # Retrieve using session id
        order.has_paid = True
        order.save()
...
class PaymentFailedView(TemplateView):
    template_name = 'myapp/payment_fail.html'